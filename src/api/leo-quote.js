...
export function api_quote_post_mock(data) {
  return request({
    url: '/vue-element-admin/quote',
    method: 'post',
    data
  })
}
...
export function api_quote_put_mock(data) {
  return request({
    url: '/vue-element-admin/quote',
    method: 'post',
    data
...
export function api_quote_delete_mock(id) {
  return request({
    url: '/vue-element-admin/quote/' + id,
    method: 'delete',
  })
}
...
export function api_quote_get_mock(id) {
  return request({
    url: '/vue-element-admin/quote/' + id,
    method: 'get',
  })
...
export function api_quote_page_mock(data) {
  return request({
    url: '/vue-element-admin/quote/page',
    method: 'post',
    data
  })
}
