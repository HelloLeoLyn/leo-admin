<template>
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form"
      ...
      <div style="position:relative" class="filter-container">
        <!-- <div class="tips">
        ...
        <el-checkbox class="filter-item">记住我</el-checkbox>
        <el-button class="thirdparty-button filter-item" type="primary" @click="showDialog=true">
          Or connect with
        </el-button>
      </div>
    </el-form>
